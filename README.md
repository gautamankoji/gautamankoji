<!-- Profile | Github gautamankoji/README.md -->
...
<div align="center">
  ...
  **`Astrophysics`** | **`Full stack Development`** | **`Compitative Programming`** | **`Pen Testing`** | **`Designing and Editing`** | **`Game Development`** 
